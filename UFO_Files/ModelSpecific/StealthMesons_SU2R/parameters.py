...
PionMass = Parameter(name = 'PionMass',
                     nature = 'external',
                     type = 'real',
                     value = 150.,
                     texname = 'M_{\\pi }',
...
FermionEta = Parameter(name = 'FermionEta',
                       nature = 'external',
                       type = 'real',
                       value = 0.45,
                       texname = '\\eta',
...
msbarUpQuark1 = Parameter(name = 'msbarUpQuark1',
                          nature = 'internal',
                          type = 'real',
                          value = '0',
                          texname = '\\text{msbarUpQuark1}')

msbarUpQuark2 = Parameter(name = 'msbarUpQuark2',
                          nature = 'internal',
                          type = 'real',
                          value = '0.616',
                          texname = '\\text{msbarUpQuark2}')

msbarUpQuark3 = Parameter(name = 'msbarUpQuark3',
                          nature = 'internal',
                          type = 'real',
                          value = '169.2',
                          texname = '\\text{msbarUpQuark3}')

msbarDownQuark1 = Parameter(name = 'msbarDownQuark1',
                            nature = 'internal',
                            type = 'real',
                            value = '0',
                            texname = '\\text{msbarDownQuark1}')

msbarDownQuark2 = Parameter(name = 'msbarDownQuark2',
                            nature = 'internal',
                            type = 'real',
                            value = '0',
                            texname = '\\text{msbarDownQuark2}')

msbarDownQuark3 = Parameter(name = 'msbarDownQuark3',
                            nature = 'internal',
                            type = 'real',
                            value = '2.76',
...
cRhoPiPi = Parameter(name = 'cRhoPiPi',
                     nature = 'internal',
                     type = 'real',
                     value = 'CL/cmath.sqrt(NDark)',
                     texname = '\\text{cRhoPiPi}')
...
MDPc = Parameter(name = 'MDPc',
                 nature = 'internal',
                 type = 'real',
                 value = 'PionMass*cmath.sqrt(1 + (3*ee**2*cmath.log(2))/(8.*FermionEta**2*cmath.pi**2))',
                 texname = '\\text{MDPc}')
...
cKineticMixing = Parameter(name = 'cKineticMixing',
                           nature = 'internal',
                           type = 'real',
                           value = '(g1*cmath.sqrt(NDark))/(4.*cmath.pi)',
...
cPiWPi = Parameter(name = 'cPiWPi',
                   nature = 'internal',
                   type = 'complex',
                   value = '(2*FermionY**2*complex(0,1)*gw*vev**2)/(FermionA**2*FermionEta**2*PionMass**2)',
                   texname = '\\text{cPiWPi}')
